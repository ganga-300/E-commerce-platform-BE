...
function ElegantFooter() {
  return (
    <footer className="bg-gradient-to-br from-gray-50 to-gray-100 border-t border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h1 style={{ fontFamily: "TTRamillas" }} className="text-4xl font-bold text-black mb-4">
                ...
                >
                  <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-110">
                    <svg
                      ...
                      fill="currentColor"
                      className="h-5 w-5 text-[#637D37] group-hover:text-[#4a5a2a] transition-colors"
                      viewBox="0 0 24 24"
                    >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="/about"
                  className="text-gray-600 hover:text-[#637D37] transition-colors duration-200 flex items-center group"
                >
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center group">
                <div className="w-10 h-10 bg-[#637D37]/10 rounded-lg flex items-center justify-center mr-4 group-hover:bg-[#637D37]/20 transition-colors">
                  <Phone className="w-5 h-5 text-[#637D37]" />
                </div>
                <div>
                  <p className="text-sm text-gray-500">Call us</p>
                  <a href="tel:7067909690" className="text-gray-800 hover:text-[#637D37] transition-colors font-medium">
                    7067909690
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center group">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-gray-800 hover:text-[#637D37] transition-colors font-medium"
                  >
              ...
              <div className="flex items-center group">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium">Available Online 24/7</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Newsletter Section */}
      <div className="bg-[#637D37]/5 border-t border-[#637D37]/10">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-lg font-bold text-gray-800 mb-2">Stay Updated</h3>
              <p className="text-gray-600">Get the latest study materials and exclusive offers</p>
            </div>
            <div className="flex w-full md:w-auto max-w-md">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 rounded-l-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#637D37] focus:border-transparent"
              />
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex space-x-6 text-sm">
              <a href="/privacy" className="text-gray-600 hover:text-[#637D37] transition-colors">
                Privacy
              </a>
              <a href="/terms" className="text-gray-600 hover:text-[#637D37] transition-colors">
                Terms
              </a>
              <a href="/cookies" className="text-gray-600 hover:text-[#637D37] transition-colors">
                Cookies
              </a>
            </div>
          </div>
